  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      <div
        ...
        style={{ background: 'radial-gradient(circle at 35% 35%,rgba(125,171,255,.22),rgba(125,171,255,0) 65%)' }}
      />
      <div
        className="animate-float-blob2 absolute top-[8%] -right-[16%] h-[58%] w-[58%] rounded-full blur-[46px]"
        style={{ background: 'radial-gradient(circle at 50% 50%,rgba(129,140,255,.16),rgba(129,140,255,0) 70%)' }}
      />
      <div
        className="animate-float-blob-rev absolute -bottom-[18%] left-[12%] h-[66%] w-[66%] rounded-full blur-[52px]"
        style={{ background: 'radial-gradient(circle at 50% 50%,rgba(70,210,200,.2),rgba(70,210,200,0) 70%)' }}
      />
      <div
        className="animate-float-blob2-rev absolute -bottom-[6%] right-0 h-[44%] w-[44%] rounded-full blur-[48px]"
        style={{ background: 'radial-gradient(circle at 50% 50%,rgba(150,180,255,.14),rgba(150,180,255,0) 70%)' }}
      />
      <div
        className="animate-float-blob-slow absolute top-[38%] left-[38%] h-[30%] w-[30%] rounded-full blur-[40px]"
        style={{ background: 'radial-gradient(circle at 50% 50%,rgba(255,255,255,.5),rgba(255,255,255,0) 70%)' }}
      />
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse 120% 90% at 50% 30%,rgba(0,0,0,0) 55%,rgba(20,30,60,.05) 100%)' }}
      />
      <div
        className="absolute inset-0"
        style={{ background: 'linear-gradient(115deg,rgba(255,255,255,.35) 0%,rgba(255,255,255,0) 22%,rgba(255,255,255,0) 78%,rgba(255,255,255,.2) 100%)' }}
      />
    </div>
  );
}
