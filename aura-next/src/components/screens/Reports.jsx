    ...
    <div className="grid animate-fade-up grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {rows.map((r) => (
        <div key={r.id} className="glass-card flex flex-col p-4">
          <div
            className="mb-4 flex h-[118px] items-end rounded-2xl border border-white/60 p-3.5 dark:border-white/10"
          ...
          <div className="flex items-center justify-between border-t border-[rgba(var(--tint-slate),.08)] pt-3.5">
